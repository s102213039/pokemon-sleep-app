...
(function () {
  ...
  const DICTIONARY = {
    'zh-TW': {
      ...
      'box.modal_search_placeholder': '搜尋寶可夢 (中文/英文/編號)...',
      'box.modal_clear_active_subskill': '✕ 清空此格',
      'box.modal_ing_lv1': 'Lv.1 初始食材',
      'box.modal_ing_lv30': 'Lv.30 解鎖食材',
      'box.modal_ing_lv60': 'Lv.60 解鎖食材',
    ...
    'en-US': {
      ...
      'box.modal_search_placeholder': 'Search Pokémon (Name/EN/No)...',
      'box.modal_clear_active_subskill': '✕ Clear Slot',
      'box.modal_ing_lv1': 'Lv.1 Base Ingredient',
      'box.modal_ing_lv30': 'Lv.30 Ingredient',
      'box.modal_ing_lv60': 'Lv.60 Ingredient',
