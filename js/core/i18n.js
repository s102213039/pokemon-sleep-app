...
(function () {
  ...
  const DICTIONARY = {
    'zh-TW': {
      ...
      'settings.theme_onyx_sub': 'OLED 純粹黑 · 鈦金冷灰點綴',
      'settings.theme_dawn': '晨曦暖陽',
      'settings.theme_dawn_sub': '溫潤奶油白 · 蔚藍暖陽點綴',
      'settings.theme_emerald': '雅緻灰石',
      'settings.theme_emerald_sub': '極簡淺灰底 · 冷鈦深灰點綴',
      'settings.theme_active': '✓ 使用中',
      'settings.theme_invert': '反色模式',
      'settings.theme_invert_desc': '反轉當前主題的深淺底色，拓展出 4 款高反差風格。',
      ...
      'settings.box_export_btn': '匯出備份 JSON',
      'settings.box_import_btn': '匯入還原 JSON',
      'settings.save': '儲存設定',
      'settings.close': '關閉',
      ...
      'recipe.all': '全部',
      'recipe.pot_35': '≥ 35（中階料理）',
      'recipe.pot_55': '≥ 55（中高階料理）',
      'recipe.pot_67': '≥ 67（高階大料理）',
      'recipe.pot_87': '≥ 87（特階大料理）',
      'recipe.pot_100': '≥ 100（頂級究極）',
      ...
      'recipes.filter_title': '食譜篩選器',
      'recipes.reset_all': '全部重設',
      'recipes.search_placeholder': '搜尋食譜名稱 (中/英) 或食材關鍵字...',
      'recipes.loading': '食譜資料載入中，請稍候...',
      ...
      'wiki.subtab_islands': '研究營地與島嶼',
      'wiki.tab_islands': '研究營地與島嶼',
      'wiki.islands_title': '7大研究營地與EX專家模式全覽',
      ...
      'wiki.islands_spawns_title': '各睡眠類型寶可夢與睡姿星級門檻',
      'wiki.islands_legendary_toggle': '神獸寶可夢',
      'wiki.islands_legendary_empty': '目前選取條件下無棲息之神獸寶可夢',
      'wiki.islands_guide_title': '睡意之力與睡姿解鎖核心規則',
      ...
      'box.add_pokemon_short': '手動新增',
      'box.add_pokemon_sub': '自訂數值錄入',
      'box.export': '匯出備份',
      ...
      'box.dropzone_btn': '截圖智能辨識',
      'box.dropzone_sub_short': '支援單張 / 批次多選',
      ...
      'box.view_cards': '卡片',
      'box.view_table': '表格',
      'box.empty_title': '目前尚未登錄任何寶可夢',
      'box.empty_desc': '請點擊右下角按鈕開始截圖辨識或手動新增！',
      'box.empty_hint': '請點擊右下角的「截圖辨識」或「手動新增」按鈕開始建立你的幫手隊伍！',
      ...
      'box.modal_poke_subskills': '副技能組合',
      'box.modal_poke_ribbon': '睡飽飽獎章',
      'box.modal_main_skill': '主技能資訊',
      'box.modal_skill_level': '技能等級',
      'box.ribbon_none': '未佩戴 (0h)',
      'box.ribbon_lv1': '200 小時 (+1 持有上限)',
      'box.ribbon_lv2': '500 小時 (+3 持有上限 · 幫速加成)',
      'box.ribbon_lv3': '1000 小時 (+6 持有上限)',
      'box.ribbon_lv4': '2000 小時 (+8 持有上限 · 幫速最大加成)',
      ...
      'pokedex.formula_title': '產能算法精算拆解',
      'pokedex.final_ing_rate': '最終食材發動率',
      'pokedex.daily_helps': '預估每日幫忙次數',
      'pokedex.daily_ing_yield': '預估單日食材產量',
      'pokedex.preset_god': '畢業神配置',
      'pokedex.preset_reset': '重置',
      'pokedex.click_appraise': '點擊查看詳細資訊與強度評測',
      'pokedex.level_slider': '等級設定',
      'pokedex.subskills_title': '副技能自訂 (5個槽位)',
      'pokedex.ingredients_title': '食材組合 (Lv.1 / 30 / 60)',
      'pokedex.main_skill_level': '主技能等級',
      'pokedex.extra_skill_ing': '主技能期望附加食材',
      'pokedex.evo_req': '進化條件',
      'pokedex.evo_guard_below': '進化門檻 Lv.',
      'pokedex.evo_guard_met': '已達門檻 Lv.',
      'pokedex.evo_guard_tip_below': '此形態最低進化等級為 Lv.{0}，點擊可快速調整至門檻等級',
      'pokedex.evo_guard_tip_met': '已達此形態最低進化門檻 (Lv.{0}+)',
      'box.guide_title': '標準截圖示範例與必備資訊',
      'box.guide_collapse': '收合說明',
      'box.guide_expand': '展開說明',
      'box.guide_click_zoom': '點擊放大檢視',
      'box.guide_sample_label': '官方遊戲詳細資訊全幅示範',
      'box.guide_info_heading': '標準截圖必備 5 大核心資訊 (確保 100% 辨識率)：',
      'box.guide_item1_title': '頂部資訊 (名稱與等級)',
      'box.guide_item1_desc': '包含完整的寶可夢名稱 (如 赫拉克羅斯) 與等級 (如 Lv. 52), 文字清晰無遮蔽。',
      'box.guide_item2_title': '食材組合 (Lv.1 / 30 / 60)',
      'box.guide_item2_desc': '清晰顯示三個等級之解鎖食材圖示與獲得數量 (如 甜甜蜜x1, 品鮮蘑菇x1, 甜甜蜜x4)。',
      'box.guide_item3_title': '主技能資訊',
      'box.guide_item3_desc': '顯示完整主技能名稱 (如 健美 / 料理輔助S) 與目前技能等級 (如 Lv.7)。',
      'box.guide_item4_title': '副技能欄位 (全部 5 格)',
      'box.guide_item4_desc': '完整露出 Lv.10 至 Lv.80 (或 100) 共 5 個副技能方塊按鈕, 無選單或彈窗覆蓋遮擋。',
      'box.guide_item5_title': '性格與能力修正',
      'box.guide_item5_desc': '底部性格名稱 (如 慎重) 及對應的主技能發動率 / 食材發現率加減成箭頭 (▲▲ / ▼▼)。',
      'box.guide_tip_badge': '提示',
      'box.guide_tip_text': '請截取遊戲中「詳細資訊」完整畫面, 避開半透明浮動選單覆蓋, 即可實現高精準度秒速辨識！',
    ...
    'en-US': {
      ...
      'brand.subtitle': 'Stats, Rates, Ingredients & Pokedex',
      'nav.pokemon': '⚡ Dex',
      'nav.recipes': '🍲 Dishes',
      'nav.wiki': '📚 Wiki',
      'nav.box': '📦 Box',
      ...
      'settings.theme_onyx_sub': 'Pure OLED Black · Slate Titanium Accents',
      'settings.theme_dawn': 'Dawn Amber',
      'settings.theme_dawn_sub': 'Warm Cream White · Cyan Sun Accents',
      'settings.theme_emerald': 'Minimalist Slate',
      'settings.theme_emerald_sub': 'Clean Light Slate · Titanium Slate Accents',
      'settings.theme_active': '✓ Active',
      'settings.theme_invert': 'Invert Colors',
      'settings.theme_invert_desc': 'Invert base lightness for 4 additional high-contrast variations.',
      ...
      'settings.box_export_btn': 'Export JSON',
      'settings.box_import_btn': 'Import JSON',
      'settings.save': 'Save',
      'settings.close': 'Close',

      // Search & Filters (Pokedex)
      'pokedex.search_placeholder': 'Search by name, No., type...',
      'pokedex.filter_bookmark': 'Filter',
      ...
      'pokedex.sort_interval_asc': '⏱️ Freq (Fast)',
      ...
      'pokedex.ref_data': '📊 Sources',
      'pokedex.target_sheet': '📋 Sheets',
      ...
      // Recipes Panel
      'recipe.search_placeholder': 'Search dish or ingredient...',
      'recipe.view_cards': '🎴 Cards',
      'recipe.view_table': '📊 Table',
      'recipe.sort_energy_desc': '⚡ Energy (Desc)',
      'recipe.sort_energy_asc': '⚡ Energy (Asc)',
      'recipe.sort_pot_asc': '🍲 Pot (Asc)',
      'recipe.sort_pot_desc': '🍲 Pot (Desc)',
      'recipe.sort_bonus_desc': '🥩 Bonus (Desc)',
      'recipe.sort_name_asc': '🔤 Name',
      'recipe.filter_bookmark': 'Filter',
      'recipe.filter_sidebar_title': 'Filter',
      'recipes.filter_title': 'Filter',
      'recipes.reset_all': 'Reset',
      'recipes.search_placeholder': 'Search dish or ingredient...',
      'recipes.loading': 'Loading...',
      'recipe.calc_settings': 'Simulation',
      'recipe.all_categories': 'All',
      'recipe.category_label': 'Category',
      'recipe.bonus_label': 'Min Bonus',
      'recipe.pot_label': 'Min Pot Size',
      'recipe.all': 'All',
      'recipe.pot_35': '≥ 35 (Mid)',
      'recipe.pot_55': '≥ 55 (Adv)',
      'recipe.pot_67': '≥ 67 (High)',
      'recipe.pot_87': '≥ 87 (Master)',
      'recipe.pot_100': '≥ 100 (Grand)',
      ...
      'recipe.filter_included': 'Include',
      'recipe.filter_excluded': 'Exclude',
      'recipe.match_any': 'Any',
      'recipe.match_all': 'All',
      'recipe.clear_all': 'Clear',
      'recipe.clear_excluded': 'Clear',
      ...
      'recipe.th_name': 'Dish',
      'recipe.th_dish': 'Dish',
      'recipe.th_type': 'Category',
      'recipe.th_category': 'Category',
      'recipe.th_pot': 'Pot',
      'recipe.th_ingredients': 'Ingredients',
      'recipe.th_base_energy': 'Base',
      'recipe.th_bonus': 'Bonus',
      'recipe.th_final_energy': 'Energy',

      // Wiki Panel
      'wiki.title': 'Strategy & Data Wiki',
      'wiki.subtab_skills': 'Main Skills',
      'wiki.subtab_subskills': 'Sub-Skills',
      'wiki.subtab_ratings': 'Tier Guide',
      'wiki.subtab_ingredients': 'Ingredient Ladder',
      'wiki.subtab_values': 'Berry & Ings',
      'wiki.tab_skills': 'Main Skills',
      'wiki.tab_subskills': 'Sub-Skills',
      'wiki.tab_ratings': 'Tier Guide',
      'wiki.tab_ladder': 'Ingredient Ladder',
      'wiki.tab_values': 'Berry & Ings',
      'wiki.subtab_islands': 'Camps & EX',
      'wiki.tab_islands': 'Camps & EX',
      'wiki.islands_title': 'Research Camps & EX Mode',
      'wiki.islands_select_label': 'Select Camp:',
      'wiki.islands_unlock_goal': 'Unlock Goal',
      'wiki.islands_snorlax_mult': 'Snorlax Multiplier',
      'wiki.islands_fav_berries': 'Favored Berries',
      'wiki.islands_expert_btn': 'Toggle EX Mode',
      'wiki.islands_normal_btn': 'Normal Camp',
      'wiki.islands_ranks_title': 'Snorlax Ranks & Energy',
      'wiki.islands_spawns_title': 'Habitats & Sleep Styles',
      'wiki.islands_legendary_toggle': 'Legendary',
      'wiki.islands_legendary_empty': 'No legendary Pokémon found for current selection',
      'wiki.islands_guide_title': 'Drowsy Power Guide',
      'wiki.skill_type_label': 'Category:',
      'wiki.skill_all': 'All Skills (22)',
      'wiki.skill_energy': '⚡ Strength',
      'wiki.skill_energy_heal': '💖 Recovery',
      'wiki.skill_ingredient': '🥗 Ingredients',
      'wiki.skill_special': '👑 Special',
      'wiki.skill_shards': '💎 Shards',
      'ladder.search_placeholder': 'Search tracks...',
      'ladder.filter_all': 'All',
      'ladder.filter_aaa': '👑 AAA',
      ...
      'box.tab_list': 'Pokémon Box',
      'box.tab_lab': 'Appraisal Lab',
      'box.fab_scan': 'Scan OCR',
      'box.fab_add': 'Add Pokémon',
      'box.appraisal_lab_btn': 'Appraisal Lab',
      'box.appraisal_lab': 'Appraisal Lab',
      'box.manual_add': 'Add Pokémon',
      'box.add_pokemon': 'Add Pokémon',
      'box.add_pokemon_short': 'Add',
      'box.add_pokemon_sub': 'Custom entry',
      'box.export': 'Export',
      'box.export_backup': 'Export JSON',
      'box.import': 'Import',
      'box.import_backup': 'Import JSON',
      'box.dropzone_title': 'Click or drop screenshots here, or paste with Ctrl+V / Cmd+V',
      'box.dropzone_sub': 'Auto-detect: Name · Level · Lv.1/30/60 Ings · 5 Sub-skills · Nature · Deduplication',
      'box.dropzone_btn': 'OCR Scan',
      'box.dropzone_sub_short': 'OCR Scan',
      'box.search_placeholder': 'Search box Pokémon by name, nature, sub-skill...',
      'box.sort_pr_desc': 'PR (Desc)',
      'box.sort_created_desc': 'Recent',
      'box.sort_recent': 'Recent',
      'box.sort_level_desc': 'Level (Desc)',
      'box.sort_level_asc': 'Level (Asc)',
      'box.sort_pr_asc': 'PR (Asc)',
      'box.sort_id_asc': 'No. (Asc)',
      'box.sort_dex_asc': 'No. (Asc)',
      'box.view_cards': 'Cards',
      'box.view_table': 'Table',
      'box.empty_title': 'No Pokémon in your box yet',
      'box.empty_desc': 'Tap the bottom-right button to scan screenshots or add manually.',
      'box.empty_hint': 'Tap the "Scan OCR" or "Add Pokémon" button at the bottom right to start building your helper team!',
      'box.modal_title': 'Confirm Entry',
      ...
      'box.modal_clear_all_subskills': 'Clear',
      'box.modal_clear_active_subskill': 'Clear',
      'box.modal_ing_lv1': 'Lv.1',
      'box.modal_ing_lv30': 'Lv.30',
      'box.modal_ing_lv60': 'Lv.60',
      ...
      'box.modal_poke_ribbon': 'Good-Night Ribbon',
      'box.modal_main_skill': 'Main Skill',
      'box.modal_skill_level': 'Skill Level',
      'box.ribbon_none': 'None (0h)',
      'box.ribbon_lv1': '200h (+1 Carry)',
      'box.ribbon_lv2': '500h (+3 Carry · Speed)',
      'box.ribbon_lv3': '1000h (+6 Carry)',
      'box.ribbon_lv4': '2000h (+8 Carry · Max Speed)',
      'appraisal.ribbon_label': 'Ribbon:',
      'wiki.ribbon_title': 'Good-Night Ribbon Guide',
      'box.modal_cancel': 'Cancel',
      'box.modal_save': 'Save',
      'pokedex.appraisal_modal_title': 'Pokémon Appraisal',
      'pokedex.base_stats': 'Base Stats',
      'pokedex.custom_controls': 'Custom Config',
      'pokedex.formula_title': 'Yield Formula Breakdown',
      'pokedex.final_ing_rate': 'Final Ing. Rate',
      'pokedex.daily_helps': 'Est. Helps',
      'pokedex.daily_ing_yield': 'Est. Ing. Yield',
      'pokedex.preset_god': 'God Tier',
      'pokedex.preset_reset': 'Reset',
      'pokedex.click_appraise': 'Click for details & appraisal',
      'pokedex.level_slider': 'Level',
      'pokedex.subskills_title': 'Sub-Skills (5 Slots)',
      'pokedex.ingredients_title': 'Ingredients (Lv.1 / 30 / 60)',
      'pokedex.main_skill_level': 'Skill Level',
      'pokedex.extra_skill_ing': 'Skill Yield Boost',
      'pokedex.evo_req': 'Evo Req',
      'pokedex.evo_guard_below': 'Min Evo Lv.',
      'pokedex.evo_guard_met': 'Evo Lv.',
      'pokedex.evo_guard_tip_below': 'Min evo level is Lv.{0}. Click to jump to Lv.{0}.',
      'pokedex.evo_guard_tip_met': 'Evolution requirement (Lv.{0}+) met.',
      'box.guide_title': 'Screenshot Guide',
      'box.guide_collapse': 'Collapse',
      'box.guide_expand': 'Guide',
      'box.guide_click_zoom': 'Enlarge',
      'box.guide_sample_label': 'Sample',
      'box.guide_info_heading': '5 Elements for OCR:',
      'box.guide_item1_title': 'Header (Name & Level)',
      'box.guide_item1_desc': 'Clear Pokémon name (e.g. Heracross) and level (e.g. Lv. 52).',
      'box.guide_item2_title': 'Ingredients (Lv.1 / 30 / 60)',
      'box.guide_item2_desc': 'Visible ingredient icons and quantities (e.g. Honey x1, Mushroom x1).',
      'box.guide_item3_title': 'Main Skill',
      'box.guide_item3_desc': 'Full main skill title (e.g. Cooking Power-Up S) and level.',
      'box.guide_item4_title': 'Sub-Skills (5 Slots)',
      'box.guide_item4_desc': 'All 5 slots fully visible without obstruction.',
      'box.guide_item5_title': 'Nature & Modifiers',
      'box.guide_item5_desc': 'Nature name with buff/debuff arrows (▲▲ / ▼▼).',
      'box.guide_tip_badge': 'Tip',
      'box.guide_tip_text': 'Capture full "Details" screen without dark menus for instant recognition.',
      'appraisal.title': 'Career Appraisal',
      'appraisal.radar_berry': 'Berry',
      'appraisal.radar_ing': 'Ingredient',
      'appraisal.radar_skill': 'Skill',
      'appraisal.radar_speed': 'Speed',
      'appraisal.radar_growth': 'Growth',
      'appraisal.radar_roi': 'ROI',
      'appraisal.select_from_box': 'Select from Box:',
      'appraisal.custom_simulation': 'Custom Sim',
      'appraisal.box_empty_tip': 'Tip: Register Pokémon in Box tab to evaluate here.',
      'appraisal.in_box_badge': 'In Box',
      'appraisal.simulated_badge': 'Simulation',
      'appraisal.reset_box_btn': 'Reset Stats',
      'appraisal.quick_pick': 'Quick Pick:',
      ...
      // News & Timeline
      'news.title': '📰 Latest Events & News',
      'news.timeline_title': '⏰ Event Timeline',
      'news.search_placeholder': 'Search news, Pokémon...',
      ...
      'news.source_hint': '🤖 AI Summary · Source: ',
      'news.source_full_hint': '🤖 AI Summary · Source: <a href="https://www.pokemonsleep.net/en/news/" target="_blank" rel="noopener noreferrer">Pokémon Sleep Official Website</a>'
    }
  };
  ...
  const MAIN_SKILL_NAMES = {
    ...
    '食材精選': { 'zh-TW': '食材精選', 'en-US': 'Ingr. Selection' },
  ...
  const SUBSKILL_NAMES = {
    ...
    '食材機率M': { 'zh-TW': '食材機率M', 'en-US': 'Ingredient Finder M' },
    '食材機率S': { 'zh-TW': '食材機率S', 'en-US': 'Ingredient Finder S' },
    ...
    '技能等級M': { 'zh-TW': '技能等級M', 'en-US': 'Skill Level Up M' },
    '技能等級S': { 'zh-TW': '技能等級S', 'en-US': 'Skill Level Up S' },
    ...
    '持有上限L': { 'zh-TW': '持有上限L', 'en-US': 'Inventory Up L' },
    '持有上限M': { 'zh-TW': '持有上限M', 'en-US': 'Inventory Up M' },
    '持有上限S': { 'zh-TW': '持有上限S', 'en-US': 'Inventory Up S' },
    '持有上限 L': { 'zh-TW': '持有上限 L', 'en-US': 'Inventory Up L' },
    '持有上限 M': { 'zh-TW': '持有上限 M', 'en-US': 'Inventory Up M' },
    '持有上限 S': { 'zh-TW': '持有上限 S', 'en-US': 'Inventory Up S' },
  ...
  function translateDynamicText(text) {
    ...
    res = res
      ...
      .replace(/[（\(](\d[\d,，\s]*)\s*(?:鑽石|Diamonds)[）\)]/gi, (match, p1) => ` (${p1.replace(/[，\s]/g, ',')} Diamonds)`)
    ...
    res = res
      ...
      .replace(/[（\(]體型日產\s*(\d+)~(\d+)\s*顆[）\)]/g, '(Sizes: $1~$2/day)')
      .replace(/[（\(]體型日產\s*(\d+)\s*顆[）\)]/g, '(Sizes: $1/day)')
      .replace(/[（\(]8種進化產量皆相同[）\)]/g, '(All 8 Evolutions Equal)')
      .replace(/顆\/天/g, '/day')
      .replace(/顆/g, 'items')
