...
(function () {
  ...
  const DICTIONARY = {
    ...
    'en-US': {
      ...
      'settings.lang_en': 'English',
      'settings.box_backup_section': 'Box Backup & Restore',
      'settings.box_backup_desc': 'Export your Pokémon box to JSON backup or import from file.',
      'settings.box_export_btn': 'Export JSON Backup',
      ...
      'recipe.all': 'All',
      'recipe.pot_35': '≥ 35 (Mid-tier)',
      'recipe.pot_55': '≥ 55 (Advanced)',
      'recipe.pot_67': '≥ 67 (High-tier)',
      'recipe.pot_87': '≥ 87 (Master)',
      'recipe.pot_100': '≥ 100 (Grand Master)',
      ...
      'wiki.subtab_islands': 'Research Camps & Islands',
      'wiki.tab_islands': 'Research Camps & Islands',
      'wiki.islands_title': 'Research Camps & EX Expert Mode Guide',
      ...
      'wiki.islands_expert_btn': 'Toggle EX Expert Mode',
      'wiki.islands_normal_btn': 'Back to Normal Camp',
      'wiki.islands_ranks_title': 'Snorlax Rank Energy & Drowsy Power',
      'wiki.islands_spawns_title': 'Sleep Types & Sleep Style Star Tiers',
      'wiki.islands_guide_title': 'Drowsy Power & Sleep Style Mechanics Guide',
      ...
      'box.add_pokemon_short': 'Add Manually',
      ...
      'box.dropzone_btn': 'Smart OCR Scan',
      'box.dropzone_sub_short': 'Single / Batch OCR',
      ...
      'box.ribbon_lv1': '200 hrs (+1 Carry Limit)',
      'box.ribbon_lv2': '500 hrs (+3 Carry · Speed Boost)',
      'box.ribbon_lv3': '1000 hrs (+6 Carry Limit)',
      'box.ribbon_lv4': '2000 hrs (+8 Carry · Max Speed Boost)',
      'appraisal.ribbon_label': 'Good-Night Ribbon:',
      'wiki.ribbon_title': 'Good-Night Ribbon Mechanics Guide',
      'box.modal_cancel': 'Cancel',
      'box.modal_save': 'Save Pokémon',
      'pokedex.appraisal_modal_title': 'Pokémon Appraisal & Customization',
      'pokedex.base_stats': 'Base Stats',
      'pokedex.custom_controls': 'Custom Configuration',
      'pokedex.formula_title': 'Yield Formula Breakdown',
      'pokedex.final_ing_rate': 'Final Ingredient Rate',
      'pokedex.daily_helps': 'Estimated Daily Helps',
      'pokedex.daily_ing_yield': 'Estimated Daily Ingredient Yield',
      'pokedex.preset_god': 'God Tier Preset',
      'pokedex.preset_reset': 'Reset',
      'pokedex.click_appraise': 'Click for details & appraisal',
      'pokedex.level_slider': 'Level Setting',
      'pokedex.subskills_title': 'Sub-Skills (5 Slots)',
      'pokedex.ingredients_title': 'Ingredients (Lv.1 / 30 / 60)',
      'pokedex.main_skill_level': 'Main Skill Level',
      'pokedex.extra_skill_ing': 'Extra Yield from Main Skill',
      'pokedex.evo_req': 'Evolution Req',
      'pokedex.evo_guard_below': 'Min Evo Lv.',
      'pokedex.evo_guard_met': 'Evo Lv.',
      'pokedex.evo_guard_tip_below': 'Minimum evolution level is Lv.{0}. Click to jump to Lv.{0}.',
      'pokedex.evo_guard_tip_met': 'Evolution level requirement (Lv.{0}+) satisfied.',
      'box.guide_title': 'Standard Screenshot Guide & Requirements',
      'box.guide_collapse': 'Collapse',
      'box.guide_expand': 'Expand Guide',
      'box.guide_click_zoom': 'Click to Enlarge',
      'box.guide_sample_label': 'Full In-Game Details Sample',
      'box.guide_info_heading': '5 Essential Elements for 100% OCR Accuracy:',
      'box.guide_item1_title': 'Header (Name & Level)',
      'box.guide_item1_desc': 'Clear Pokémon name (e.g. Heracross) and level (e.g. Lv. 52) without obstruction.',
      'box.guide_item2_title': 'Ingredients (Lv.1 / 30 / 60)',
      'box.guide_item2_desc': 'Distinct ingredient icons and unlocked quantities (e.g. Honey x1, Tasty Mushroom x1, Honey x4).',
      'box.guide_item3_title': 'Main Skill',
      'box.guide_item3_desc': 'Full main skill title (e.g. Cooking Power-Up S) and skill level (e.g. Lv.7).',
      'box.guide_item4_title': 'Sub-Skills (All 5 Slots)',
      'box.guide_item4_desc': 'All 5 slots (Lv.10 to Lv.80/100) fully visible without overlapping menus.',
      'box.guide_item5_title': 'Nature & Stat Modifiers',
      'box.guide_item5_desc': 'Nature name capsule (e.g. Careful) with buff/debuff arrows (▲▲ / ▼▼).',
      'box.guide_tip_badge': 'Tip',
      'box.guide_tip_text': 'Capture the full in-game "Details" screen without dark overlay menus for instant accurate recognition!',
